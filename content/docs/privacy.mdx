...
We use third party services such as APIs from companies like Google. For example, when you sync your Google Calendar with your Mentors CX account, you give access to read and edit your calendar. Reading allows it to know when you're available and when you're busy to avoid double bookings. And editing allows the API to book the meeting automatically once you accept a session (or your session request is accepted), making it easier for you to manage your availability and schedule.

Mentors CX's use and transfer to any other app of information received from Google APIs will adhere to <a href="https://developers.google.com/terms/api-services-user-data-policy#additional_requirements_for_specific_api_scopes" target="_blank" rel="noopener noreferrer">Google API Services User Data Policy</a>, including the Limited Use requirements.

### Contact us

You can assist us by keeping your personal contact information up to date. If you wish to access your information, have any questions, comments, or suggestions, or if you notice any errors in the information we have about you, please reach out to us at mentorscx@gmail.com. Should you have any concerns regarding our compliance with privacy laws, we will investigate your complaint and, if necessary, take appropriate action.
